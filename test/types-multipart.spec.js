  ...
  const tests = [
    {
      ...
      config: {
        ignoreUndefinedFieldnames: true
      },
      expected: [
    ...
    },
    {
      source: [
        ['-----------------------------paZqsnEHRufoShdX6fh0lUhXBP4k',
          'Content-Disposition: form-data; filename="1k_a.dat"',
      ...
      what: 'should ignore files without name'
    },
    {
      source: [
        ['-----------------------------paZqsnEHRufoShdX6fh0lUhXBP4k',
      ...
      boundary: '---------------------------paZqsnEHRufoShdX6fh0lUhXBP4k',
      config: {
        ignoreUndefinedFieldnames: false
      },
      expected: [
        ['field', undefined, 'super alpha file', false, false, '7bit', 'text/plain'],
        ['field', 'file_name_1', 'super beta file', false, false, '7bit', 'text/plain']
      ],
      what: 'should not ignore fields without name when ignoreUndefinedFieldnames is set to false'
    },
    {
      source: [
        ['-----------------------------paZqsnEHRufoShdX6fh0lUhXBP4k',
      ...
      what: 'should ignore fields without name by default'
    },
    {
      source: [
        ['-----------------------------paZqsnEHRufoShdX6fh0lUhXBP4k',
      ...
      boundary: '---------------------------paZqsnEHRufoShdX6fh0lUhXBP4k',
      expected: [
        ['file', undefined, 1023, 0, '1k_a.dat', '7bit', 'application/octet-stream'],
        ['file', 'upload_file_1', 1023, 0, '1k_b.dat', '7bit', 'application/octet-stream']
      ],
      what: 'should not ignore files without name by default'
    },
    {
      source: [
        ['-----------------------------paZqsnEHRufoShdX6fh0lUhXBP4k',
